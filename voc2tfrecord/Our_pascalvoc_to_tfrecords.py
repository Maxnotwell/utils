...
from Our_dataset_utils import int64_feature, float_feature, bytes_feature
from Our_pascalvoc_common import ARTIFACT_LABELS
...
def _process_image(directory, name):
    ...
    for obj in root.findall('object'):
        ...
        labels.append(int(ARTIFACT_LABELS[label][0]))
